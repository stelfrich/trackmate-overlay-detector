...
import fiji.plugin.trackmate.detection.OverlayDetector;
 ...
 */
public class ObjectDetectorConfigurationPanel extends BasicDetectorConfigurationPanel
{

	private static final long serialVersionUID = -1L;

	public ObjectDetectorConfigurationPanel( final ImagePlus imp, final Settings settings, final Model model, final String infoText, final String detectorName )
	{
