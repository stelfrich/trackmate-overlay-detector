...
/**
 * {@link SpotDetectorFactory} for an {@link OverlayDetector}.
 * 
...
public class OverlayDetectorFactory< T extends RealType< T > & NativeType< T > > implements SpotDetectorFactory< T >
{
	...
	public SpotDetector< T > getDetector( final Interval interval, int frame )
	{
		...
		OverlayDetector< T > detector = new OverlayDetector<>( imgZT, imp, frame, targetChannel, spotRadius );
