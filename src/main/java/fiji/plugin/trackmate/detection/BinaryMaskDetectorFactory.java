...
import fiji.plugin.trackmate.gui.panels.detector.ObjectDetectorConfigurationPanel;
import ij.ImagePlus;

/**
 * {@link SpotDetectorFactory} for a {@link BinaryMaskDetector}.
 * 
...
public class BinaryMaskDetectorFactory< T extends RealType< T > & NativeType< T > > implements SpotDetectorFactory< T >
{
	...
	public static final String DETECTOR_KEY = "BINARY_MASK_DETECTOR";

	/** The pretty name of the target detector. */
	public static final String NAME = "Binary mask detector";

	/** An html information text. */
	public static final String INFO_TEXT = "<html>" + "This detector extracts Spots from a binary image." + "Developed by Stefan Helfrich." + "</html>";
	...
	{
		return new ObjectDetectorConfigurationPanel( settings.imp, settings, model, INFO_TEXT, NAME );
	}
