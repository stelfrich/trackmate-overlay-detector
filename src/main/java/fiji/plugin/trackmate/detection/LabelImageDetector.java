 ...
 *            type of input
 */
public class LabelImageDetector< T extends RealType< T > & NativeType< T > > implements SpotDetector< T >, MultiThreaded
{
	 ...
	 * CONSTRUCTORS
	 */
	public LabelImageDetector( final ImgPlus< T > img, final ImagePlus imp, final int frame, final int channel, double spotRadius )
	{
		this.img = img;
		this.imp = imp;
